...
# Rcpp::sourceCpp("tests/pgas_testing_rcpp_versions2.cpp")
...
set.seed(seed_nr)
pgas2c1 <- pgas2_full(10000, TT, 5, y_t, num_counts,
...
pgas2c2 <- pgas2_full_short(10000, TT, 5, y_t, num_counts,
                            test_list_Z,
                            c(prior_a, prior_b),
                            par_init_cpp_version,
                            deviate_states_init)
all.equal(pgas2c1, pgas2c2)
